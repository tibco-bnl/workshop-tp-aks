...
- [Firewall Requirements](../docs/firewall-requirements-aks) - Complete list of required endpoints
- [Network Security Group Rules](../docs/firewall-requirements-aks#8-network-security-group-nsg-rules-for-azure)
- [Azure Firewall Rules](../docs/firewall-requirements-aks#9-azure-firewall-application-rules)
- [Firewall Request Template](../docs/firewall-requirements-aks#15-simplified-firewall-request-template)

## Support

If connectivity tests fail:

1. Review the [firewall requirements document](../docs/firewall-requirements-aks)
2. Contact your network/security team with the test results
3. Use the [firewall request template](../docs/firewall-requirements-aks#sample-firewall-request-form) to request access
