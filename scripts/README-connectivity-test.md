...
- [Firewall Requirements](../docs/firewall-requirements.html) - Complete list of required endpoints
- [Network Security Group Rules](../docs/firewall-requirements.html#8-network-security-group-nsg-rules-for-azure)
- [Azure Firewall Rules](../docs/firewall-requirements.html#9-azure-firewall-application-rules)
- [Firewall Request Template](../docs/firewall-requirements.html#15-simplified-firewall-request-template)
